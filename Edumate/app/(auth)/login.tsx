...
export default function Login() {
  ...
  return (
    <View className="flex-1">
      ...
      {/* 1. Background (Consistent with Splash & Signup) */}
      <LinearGradient
      ...
      >
        <View className="flex-1 justify-end">
          ...
          <View className="px-6 pt-16 pb-8">
            ...
            <Text className="text-gray-300 text-lg mt-2">Please sign in to your account</Text>
          </View>
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
              ...
              <View className="flex-row justify-end mb-8">
                <Link href="/(auth)/forgot-pass" asChild>
                    <TouchableOpacity>
                        <Text className="text-[#8B5CF6] font-bold text-sm">Forgot Password?</Text>
                    </TouchableOpacity>
                </Link>
              </View>
